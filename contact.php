...
<head>
	...
	<title>Bright Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Bright Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>  Postmaster, <br/> Chikodi H.O, Belgaum, Karnataka, <br/>India (IN)</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:Bright.nath2@gmail.com">Bright.nath2@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+919876543210">+91 9876543210</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Bright Jobs</h5>
											<p>Bright Jobs is a job portal, online job management system developed by KLECET student for his project in November 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Bright Jobs Contact</h5>
								
								<p>Address : Postmaster, Chikodi H.O, Belgaum, Karnataka, India (IN)</p>
								<p>Email : <a href="mailto:Bright.nath2@gmail.com">Bright.nath2@gmail.com</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by KLECET student</a></li>
								</ul>
